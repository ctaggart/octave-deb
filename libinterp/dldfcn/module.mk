...
%canon_reldir%___eigs___la_LIBADD = $(DLD_LIBOCTINTERP_LIBADD) $(ARPACK_LIBS) $(SPARSE_XLIBS) $(LAPACK_LIBS) $(BLAS_LIBS)
%canon_reldir%___eigs___la_DEPENDENCIES = $(OCT_LINK_DEPS)
...
%canon_reldir%_amd_la_LIBADD = $(DLD_LIBOCTINTERP_LIBADD) $(SPARSE_XLIBS)
%canon_reldir%_amd_la_DEPENDENCIES = $(OCT_LINK_DEPS)
...
%canon_reldir%_ccolamd_la_LIBADD = $(DLD_LIBOCTINTERP_LIBADD) $(SPARSE_XLIBS)
%canon_reldir%_ccolamd_la_DEPENDENCIES = $(OCT_LINK_DEPS)
...
%canon_reldir%_chol_la_LIBADD = $(DLD_LIBOCTINTERP_LIBADD) $(SPARSE_XLIBS)
%canon_reldir%_chol_la_DEPENDENCIES = $(OCT_LINK_DEPS)
...
%canon_reldir%_colamd_la_LIBADD = $(DLD_LIBOCTINTERP_LIBADD) $(SPARSE_XLIBS)
%canon_reldir%_colamd_la_DEPENDENCIES = $(OCT_LINK_DEPS)
...
%canon_reldir%_dmperm_la_LIBADD = $(DLD_LIBOCTINTERP_LIBADD) $(SPARSE_XLIBS)
%canon_reldir%_dmperm_la_DEPENDENCIES = $(OCT_LINK_DEPS)
...
%canon_reldir%_qr_la_LIBADD = $(DLD_LIBOCTINTERP_LIBADD) $(QRUPDATE_LIBS) $(SPARSE_XLIBS)
%canon_reldir%_qr_la_DEPENDENCIES = $(OCT_LINK_DEPS)
...
%canon_reldir%_symbfact_la_LIBADD = $(DLD_LIBOCTINTERP_LIBADD) $(SPARSE_XLIBS)
%canon_reldir%_symbfact_la_DEPENDENCIES = $(OCT_LINK_DEPS)
...
%canon_reldir%_symrcm_la_LIBADD = $(DLD_LIBOCTINTERP_LIBADD) $(SPARSE_XLIBS)
%canon_reldir%_symrcm_la_DEPENDENCIES = $(OCT_LINK_DEPS)
